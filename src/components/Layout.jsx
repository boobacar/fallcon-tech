      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo-fallcon-tech.jpg" alt="Fallcon Tech" className="h-10 w-10 rounded-xl object-cover" />
            <span className="font-semibold tracking-wide">FALLCON TECH</span>
          </Link>
          ...
          <Link to="/contact" className="rounded-xl bg-blue-600 px-4 py-2 text-sm font-semibold hover:bg-blue-500">Demander un devis</Link>
        </div>
      </header>
      ...
      <footer className="mt-20 border-t border-white/10 bg-slate-950/60">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 md:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-slate-400">Agence web, SEO et solutions IT basée à Dakar.</p>
          </div>
          <div>
